...
class Home extends Component {
  ...
  handleSubmit(event) {
    ...
    if (placeArray.length) {
      this.props.history.push(
        "/Renter/" + placeArray[0][0] + "/" + placeArray[0][1]
      );
    }
  }
    ...
    return (
      <>
        <div className="hero is-desktop">
          <form
            className="searchbar animate__animated animate__pulse"
          ...
          >
            <div className="columns is-desktop">
              ...
              <div className="column" id="book">
                <label className="label" id="depart">
        ...
        <div className="content-blocks is-mobile">
          <div className="columns is-desktop">
            <div className="column is-one-third">
              <a href="/Results">
                <h2 className="left">
                  <u>Find Your Dream Vacation</u>
                </h2>
                <img src={pic1} alt="Rent Me" />
              </a>
            </div>
            ...
            <div className="column is-one-third">
              ...
              >
                <h2 className="center" id="things">
                  <u>Discover Things To Do</u>
                </h2>
                <img src={pic2} alt="Find Events" />
              </a>
            </div>
            <div className="column is-one-third">
              <a href="/Signup">
                <h2 className="right">
                  <u>List Your Property</u>
                </h2>
                <img src={pic3} alt="List a property" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="container is-centered">
          <p className="typed">
            <strong>PropUp Allows Me To:&nbsp;</strong>
            <Typical
              loop={Infinity}
              wrapper="b"
              steps={[
