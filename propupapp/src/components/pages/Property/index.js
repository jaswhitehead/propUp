...
class Property extends Component {
    ...
    constructor(props) {
          ...
          .onSnapshot((snapshot) => {
            ...
            if (minBid) {
              ...
              if (this.state.newBid > snapshot.get("minBid")) {
                ...
                bidref.update({ minBid: this.state.newBid, highBidder: this.state.highBidder });
      ...
      getOne() {
        ...
        db.collection('properties').doc(this.props.match.params.id).get().then((doc) => {
        ...
        return (
                ...
                <div className="card">
                    <div className="card-image">
                        ...
                        <img src={this.state.pic[0]} alt="House1" alt="Placeholder image" />
                        </figure>
                    </div>
                    <div className="card-content">
                        <div className="media">
                            ...
                            <div className="media-content">
                                ...
                                <p className="subtitle is-6">Listed By: <i>{this.state.owner}</i></p>
                            </div>
                        </div>

                        <div className="content">
                        <p>{this.state.description}</p>
                        <a href={`/property/${this.state.docID}`}>More Info</a><br></br>
                        <input
                          type="text"
                          name="newBid"
